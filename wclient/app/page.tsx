  ...
  return (
    <div className="min-h-screen overflow-x-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">
            ...
            <div className="hidden md:flex space-x-8">
              <a href="#solution" className="text-gray-700 hover:text-blue-600 transition">Solution</a>
      ...
      <section className="relative pt-32 pb-20 px-4 sm:px-6 lg:px-8 bg-gradient-to-br from-blue-50 via-white to-blue-50 overflow-hidden">
        ...
        <div className="absolute bottom-20 right-10 w-72 h-72 bg-purple-200 rounded-full mix-blend-multiply filter blur-xl opacity-30 animate-float" style={{animationDelay: '1s'}}></div>
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div className={`${mounted ? 'animate-fadeInLeft' : 'opacity-0'}`}>
              ...
              <h1 className="text-5xl md:text-6xl font-bold text-gray-900 mb-6 leading-tight">
                ...
                <span className="block text-blue-600 mt-2">Our nurse will.</span>
              </h1>

              <p className="text-xl text-gray-600 mb-8">
                Professional healthcare monitoring for parents in Nepal. Managed from anywhere.
              </p>
              ...
              <div className="grid grid-cols-3 gap-4">
                {[
                  ...
                  <div key={i} className={`text-center p-4 bg-white rounded-lg shadow-md animate-fadeInUp delay-${(i + 2) * 100}`}>
              ...
              <div className="relative">
                <div className="bg-white rounded-2xl shadow-2xl p-6 transform hover:scale-105 transition-all duration-500 hover:shadow-3xl">
                  <div className="flex items-center justify-between mb-6">
                    <div className="flex items-center space-x-3">
                      ...
                      <div>
                        ...
                        <div className="font-semibold text-gray-900">2 days ago</div>
                      </div>
                    </div>
                  ...
                  <div className="space-y-3">
                    {[
                      { label: "Blood Pressure", value: "120/80", status: "good" },
                      { label: "Blood Sugar", value: "Normal", status: "good" },
                      { label: "Heart Rate", value: "72 bpm", status: "good" }
                    ].map((item, i) => (
                      <div
                        key={i}
                        className={`flex justify-between items-center p-4 bg-gradient-to-r from-gray-50 to-blue-50 rounded-lg transform hover:scale-105 transition-all duration-300 cursor-pointer animate-fadeInUp delay-${(i + 5) * 100}`}
                      >
                ...
                <div className="absolute -bottom-4 -left-4 w-16 h-16 bg-purple-500 rounded-full opacity-20 animate-float" style={{animationDelay: '1.5s'}}></div>
              </div>
            </div>
          </div>
        </div>
      ...
      <section className="py-20 px-4 sm:px-6 lg:px-8 bg-white">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-12 scroll-animate">
            <h2 className="text-4xl font-bold text-gray-900 mb-4">The Crisis</h2>
            <p className="text-xl text-gray-600">2M+ Nepalese abroad. 2.5M parents alone.</p>
          </div>
          ...
          <div className="grid md:grid-cols-2 gap-8">
            <div className="relative group scroll-animate">
              ...
              <div className="relative bg-white border-2 border-red-200 rounded-2xl p-8 hover:border-red-400 transition-all duration-300">
                <h3 className="text-3xl font-bold text-red-900 mb-6">The Problem</h3>
                <div className="space-y-4">
                  <div className="flex items-start space-x-3">
                    <div className="text-3xl">😔</div>
                    <p className="text-lg text-gray-700">"I'm fine" - 75% hide illness</p>
                  </div>
                  <div className="flex items-start space-x-3">
                    <div className="text-3xl">⚠️</div>
                    <p className="text-lg text-gray-700">40% diseases found too late</p>
                  </div>
                  <div className="flex items-start space-x-3">
                    <div className="text-3xl">💔</div>
                    <p className="text-lg text-gray-700">Avoid hospitals until emergency</p>
                  </div>
                </div>
                <div className="mt-6 text-4xl font-bold text-red-600">₹800K</div>
            ...
            <div className="relative group scroll-animate">
              ...
              <div className="relative bg-white border-2 border-blue-200 rounded-2xl p-8 hover:border-blue-400 transition-all duration-300">
                <h3 className="text-3xl font-bold text-blue-900 mb-6">The Solution</h3>
                <div className="space-y-4">
                  <div className="flex items-start space-x-3">
                    <div className="text-3xl">🏠</div>
                  ...
                  <div className="flex items-start space-x-3">
                    <div className="text-3xl">📱</div>
                    <p className="text-lg text-gray-700">Real-time alerts to you</p>
                  </div>
                </div>
      ...
      <section id="solution" className="py-20 px-4 sm:px-6 lg:px-8 bg-gradient-to-br from-blue-50 to-white">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-12 scroll-animate">
            <h2 className="text-4xl font-bold text-gray-900 mb-4">How It Works</h2>
            <p className="text-xl text-gray-600">Three perspectives. One solution.</p>
          </div>
          ...
          <div className="bg-white rounded-2xl shadow-2xl p-8 min-h-[400px]">
            {activeTab === "children" && (
              <div className="animate-fadeInUp">
                <h3 className="text-3xl font-bold text-blue-900 mb-6">Your Control Center</h3>
                <div className="grid md:grid-cols-2 gap-6">
                  {[
                    { icon: "📊", title: "Real-time Dashboard", desc: "Track health trends instantly" },
                    { icon: "🚨", title: "Instant Alerts", desc: "Know when something's wrong" },
                    { icon: "💬", title: "Video Calls", desc: "Talk with nurse + parents" },
                    { icon: "💳", title: "Easy Payments", desc: "Pay from anywhere" }
                  ].map((feature, i) => (
                    <div
                      key={i}
            ...
            {activeTab === "parents" && (
              <div className="animate-fadeInUp">
                <h3 className="text-3xl font-bold text-blue-900 mb-6">Comfort at Home</h3>
                <div className="grid md:grid-cols-2 gap-6">
                  {[
                    { icon: "🏠", title: "Home Visits", desc: "45-min monthly care session" },
                    { icon: "🩺", title: "Full Tests", desc: "Blood, ECG, vitals - at home" },
                    { icon: "🗣️", title: "Nepali Reports", desc: "Voice explanations included" },
                    { icon: "💊", title: "Medicine Delivery", desc: "Track adherence" }
                  ].map((feature, i) => (
                    <div
                      key={i}
                      className="flex items-start space-x-4 p-4 rounded-lg hover:bg-blue-50 transition-all duration-300 transform hover:scale-105 cursor-pointer"
            ...
            {activeTab === "system" && (
              <div className="animate-fadeInUp">
                <h3 className="text-3xl font-bold text-blue-900 mb-6">National Impact</h3>
                <div className="grid md:grid-cols-2 gap-6">
                  {[
                    { icon: "👩‍⚕️", title: "1000+ Nurse Jobs", desc: "Stop brain drain" },
                    { icon: "💰", title: "₹2B Saved", desc: "Reduce emergency burden" },
                    { icon: "📈", title: "40% Early Detection", desc: "Prevent complications" },
                    { icon: "🔄", title: "New Model", desc: "Diaspora-funded care" }
                  ].map((feature, i) => (
                    <div
                      key={i}
                      className="flex items-start space-x-4 p-4 rounded-lg hover:bg-blue-50 transition-all duration-300 transform hover:scale-105 cursor-pointer"
      ...
      <section id="impact" className="py-20 px-4 sm:px-6 lg:px-8 bg-white" ref={statsRef}>
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-12 scroll-animate">
            <h2 className="text-4xl font-bold text-gray-900 mb-4">Real Impact</h2>
            <p className="text-xl text-gray-600">Numbers that matter</p>
          </div>

          <div className="grid md:grid-cols-3 gap-8 mb-16">
            {[
              { value: counts.nurses, label: "Nurses Employed", icon: "👩‍⚕️", color: "blue" },
              { value: counts.families, label: "Families Connected", icon: "👨‍👩‍👧‍👦", color: "purple" },
              { value: `₹${counts.savings}`, label: "Healthcare Saved", icon: "💰", color: "green" }
            ].map((stat, i) => (
              <div
                key={i}
          ...
          <div className="scroll-animate bg-gradient-to-r from-blue-600 via-blue-500 to-blue-600 rounded-2xl p-12 text-white text-center transform hover:scale-105 transition-all duration-500 shadow-2xl relative overflow-hidden">
            ...
            <div className="relative z-10">
              ...
              <div className="text-7xl font-bold mb-4 animate-pulse-slow">13 Years</div>
              <p className="text-xl">
      ...
      <section className="py-20 px-4 sm:px-6 lg:px-8 bg-gray-50">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {[
              {
                quote: "The nurse caught my mother's high BP early. Saved her life.",
                author: "Ramesh S.",
                location: "Dubai",
                emoji: "🙏"
              },
              ...
              {
                quote: "I'm the bridge between parents and children. Most meaningful work.",
                author: "Maya T.",
      ...
      <section id="pricing" className="py-20 px-4 sm:px-6 lg:px-8 bg-white">
        <div className="max-w-4xl mx-auto">
          <div className="text-center mb-12 scroll-animate">
            ...
            <p className="text-xl text-gray-600">Everything included. No surprises.</p>
          </div>
              ...
              <div className="relative bg-white border-2 border-blue-200 rounded-3xl p-8 shadow-xl hover:border-blue-400 transition-all duration-300">
                <div className="text-center mb-8">
                  ...
                  <div className="flex items-baseline justify-center mb-4">
                    <span className="text-6xl font-bold text-blue-600">₹5,000</span>
      ...
      <footer className="bg-gray-900 text-gray-300 py-12 px-4 sm:px-6 lg:px-8">
        <div className="max-w-7xl mx-auto">
          <div className="grid md:grid-cols-4 gap-8">
            ...
            <div>
              ...
              <ul className="space-y-2 text-sm">
                <li><a href="#solution" className="hover:text-blue-400 transition">How It Works</a></li>
            ...
            <div>
              ...
              <ul className="space-y-2 text-sm">
                ...
                <li><a href="#" className="hover:text-blue-400 transition">For Nurses</a></li>
              </ul>
            </div>
            <div>
          ...
          <div className="border-t border-gray-800 mt-8 pt-8 text-center text-sm">
            <p>&copy; 2025 SewaCycle. Turning remittance into remembrance.</p>
          </div>
        </div>
      </footer>
    </div>
